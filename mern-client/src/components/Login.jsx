...
//                             <p>If you have't an account. Please <Link to="/sign-up" classNameName="text-blue-600 underline">Log in</Link></p>
//                             <div className="relative">
...
//                         <button onClick={handleRegister} className="block"><img src={googleLogo.png} className="w-12 h-12 inline-block"
